        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer " style="text-align: center">
                    ...
                    <div class="col-md-3">
                        <button class="btn btn-danger " data-title="Delete" data-toggle="modal" data-dismiss="modal" data-target="#delete{{$bills->id}}">
                            Yes
                        </button>
                    </div>
                </div>
    ...
    <div class="modal fade" id="delete{{$bills->id}}" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header alert-danger">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
                    <h4 class="modal-title custom_align " id="Heading">Your reason</h4>
                </div>
                <form action="/huyDonHang/{{ $bills->id }}" method="POST" class="cancel-order">
                    ...
                    <div class="modal-footer">
                        <div class="col-md-2"></div>
                        <div class="col-md-4">
                            <button class="btn btn-default btn-danger" type="submit"><span class="glyphicon glyphicon-ok-sign"></span>Submit</button>
                        </div>
                        <div class="col-md-1">
